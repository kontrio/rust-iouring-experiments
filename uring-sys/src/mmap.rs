...
impl MappedMemory {
    ...
    pub fn debug_print_mem(&self) {
        ...
        let num_fmt: &'static [libc::c_char; 17] = &[
            b'0' as i8, b'x' as i8, b'%' as i8, b'0' as i8, b'1' as i8, b'6' as i8,  b'l' as i8, b'l' as i8, b'X' as i8, b'[' as i8,
...
impl Drop for MappedMemory {
    fn drop(&mut self) {
        if self.length > 0 {
            ...
            if munmap_result != 0 {
                panic!("a uring munmap(0x{:x}, {}) -> {} failed", self.addr as usize, self.length, last_os_err());
            }
        }
    }
}
